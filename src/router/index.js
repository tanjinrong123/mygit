 ...
 * @LastEditors: Sia
 * @LastEditTime: 2020-02-18 14:01:26
 */
import Vue from 'vue'
    ...
    },
    {
      ...
      children:[
        ...
        },
        {
          ...
          component: resolve => require(['@/components/monitor/history.vue'], resolve),
        },
        {
          // 项目分析
        ...
        },
        {
          ...
          path: '/setting/user',
          name: 'setting_user',
          component: resolve => require(['@/components/setting/user.vue'], resolve),
        },
        {
        ...
        },
        {
          ...
          component: resolve => require(['@/components/setting/permission.vue'], resolve),
        },
      ]
    }
  ]
